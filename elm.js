...
var author$project$Main$page_header = function (page) {
	if (page.$ === 'Home') {
		return _List_fromArray(
			[
				A2(
...
var author$project$Main$MenuItemClick = function (a) {
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$src('/assets/images/profile.jpg')
						]),
					_List_Nil)
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					author$project$Main$MenuItemClick(author$project$Main$Home))
				]),
			_List_fromArray(
				[
					elm$html$Html$text('Home')
			...
			_List_fromArray(
				[
					elm$html$Html$Events$onClick(
					author$project$Main$MenuItemClick(author$project$Main$Blog))
				]),
			_List_fromArray(
				[
					elm$html$Html$text('Blog')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$page_header(model.page))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"MenuItemClick":["Main.Page"]}},"Main.Page":{"args":[],"tags":{"Home":[],"Blog":[]}}}}})}});}(this));